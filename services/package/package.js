$(document).ready(async function() {
    ...
    $('.order-summary-prediscount-price').text("$" + 8 * basePrice + " ");
    $('.order-summary-postdiscount-price').text("$" + 8 * Math.ceil(0.88 * basePrice));
    ...
    var orderComplete = async function(paymentIntentId) {
        ...
        // Redirect
        window.location.replace("https://chuntutors.com/services/package/success/index.html");
    };
